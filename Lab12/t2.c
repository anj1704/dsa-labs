...
// Modify the get_graph function from Task 1 to now only use the adjacency
// matrix and not the adjacency list Allocate memory for the vertices array
// (Array of |V| graph_nodes) Initialize all the vertices to WHITE Initialize
// data to the index of the vertex
